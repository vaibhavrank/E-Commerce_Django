...
const Navbar = () => {
  ...
  return (
    <div className='px-[32px] fixed top-0 z-50 w-dvw py-[28px] bg-white flex justify-between md:px-10   items-center '>
      <div className='hidden md:flex gap-10  text-1xl justify-center'>
        <Link to={'/shop'} className=' '>Shop</Link>
        <Link to={'/newins'}>New</Link>
      ...
      <div className='flex text-[1rem] gap-6 justify-center items-center'>
            ...
            <GoSearch className='text-3xl' />
            {
              ...
              :(
                <div className='flex items-center justify-between gap-5'>
                  <Link to={'/dashboard/profile'} ><BsPerson className='text-3xl' /></Link>
                  <CiLogout 
        ...
        <Link to={'/dashboard/cart'} className='flex justify-baseline items-center gap-4' >
            <PiBag className='text-3xl' /><div className='text-3xl pb-1'>{items.length}</div>
        </Link>
      </div>
    </div>
  )
